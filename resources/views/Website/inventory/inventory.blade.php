      ...
      <div class="box">
        <div class="box-header">
          ...
          <span class="pull-right">
            <a class="btn btn-block btn-primary" href="{{url('inventory/create')}}">Add New + </a>
          </span>
...
var index_url = "{{route('website.inventory.getdata')}}";
      ...
      columns: [
        ...
        { data: null,
          render: function(data){
            ...
            var view_button = '<a href="{{url('inventory/display')}}/'+data.id+'"><i class="fa fa-eye"></i></a>';
            var edit_button = ' <a href="{{url('inventory/edit')}}/'+data.id+'"><i class="fa fa-edit"></i></a>';
            var delete_button = ' <a href="{{url('inventory/deleted')}}/'+data.id+'" onclick="return window.confirm('+text+');"><i class="fa fa-trash" style="color:red"></i></a>';
