        ...
        <div class="col-xs-12"> 
          <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{url('inventory/update')}}/{{ $inventory_record->id }}">
                    @csrf
        ...
        <div class="col-xs-12"> 
          <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{url('inventory/update_quantity')}}/{{ $inventory_record->id }}">
                    @csrf
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="opration" class="form-control">
                            ...
                            <option value="1">Remove Inventory</option>
