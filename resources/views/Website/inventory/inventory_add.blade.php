    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
            ...
            <form method="POST" action="{{url('inventory/store')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-6">
                    <label for="">Select Shopkeeper</label>  <span style="color:red"> *</span>
                    <select id="shopkeeper_id" name="shopkeeper_id" class="form-control">
