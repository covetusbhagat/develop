    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Warehouse Management</h3>
          
          <span class="pull-right">
            <a class="btn btn-block btn-primary" href="{{url('warehouse/create')}}">Add New + </a>
          </span>
...
var index_url = "{{route('website.warehouse.getData')}}";
      ...
      columns: [
        ...
        { data: null,
          render: function(data){
            ...
            var edit_button = ' <a href="{{url('warehouse/edit')}}/'+data.id+'"><i class="fa fa-edit"></i></a>';
            var delete_button = ' <a href="{{url('warehouse/deleted')}}/'+data.id+'"><i class="fa fa-trash" style="color:red"></i></a>';
