...
var index_url = "{{route('website.shoporder.getData')}}";
      ...
      columns: [
        ...
        { data: null,
          render: function(data){
            ...
            var show_button = '<a href="{{url('shoporder/display')}}/'+data.id+'"><i class="fa fa-eye"></i></a>';
            var start_button = ' <a href="{{url('shoporder/start')}}/'+data.id+'"><i class="fa fa-shopping-cart"></i></a>';

            return show_button + start_button;
          }, orderable: "false"
        },
      ]
    });
